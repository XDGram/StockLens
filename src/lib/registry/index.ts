...
const ONDO_CONTROL_DOCUMENTATION: ControlDocumentation = {
  ...
  note:
    'Freeze authority verified on-chain from each official Token-2022 mint. Ondo documents securities, AML/CFT, sanctions, wallet-screening, and transaction controls. Permanent delegate is null because the official mints do not contain that extension.',
}
